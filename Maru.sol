...
contract Maru is ERC1155, Ownable {
    
	using SafeMath for uint256;
	using Strings for string;
	
	uint256 public maruSold;
	mapping(uint256 => uint256) private _totalSupply;
	mapping(uint256 => string) public _tokenURIs;
    
    string public name = "Maru";
    string public symbol = "maru";
	string public _baseURI = "";
	uint256 public itemPrice;
	address public companyWallet = 0xf6D14956e5c77390C8367CCDbcb5b845244365dE;
	...
	function buyMaru(uint256 _howMany) public payable {
	    require(maruSold + _howMany <= 9949, "All sold out");
		require(itemPrice.mul(_howMany) == msg.value, "insufficient ETH");
		uint256 id = maruSold;
		for (uint256 i = 0; i < _howMany; i++) {
			getMaru(id+i);
		}
        maruSold = maruSold + _howMany;
	}

	function getMaru(uint256 id) private {
